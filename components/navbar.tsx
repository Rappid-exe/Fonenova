        ...
        >
          <Link href="/" className="flex items-center gap-2">
            <Image
              ...
              height={296}
              priority
              className={`w-auto object-contain transition-all duration-300 dark:hidden ${scrolled ? "h-9" : "h-12"}`}
            />
            <Image
              ...
              height={296}
              priority
              className={`w-auto object-contain transition-all duration-300 hidden dark:block ${scrolled ? "h-9" : "h-12"}`}
            />
          </Link>
